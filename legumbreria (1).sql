...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-04-2025 a las 03:47:55
...
-- Funciones
--
CREATE DEFINER=`` FUNCTION `estado_producto` (`id_producto` INT) RETURNS VARCHAR(20) CHARSET utf8mb4 COLLATE utf8mb4_general_ci DETERMINISTIC BEGIN
...
--
ALTER TABLE `auditorias_de_pedidos`
  ADD CONSTRAINT `auditorias_de_pedidos_ibfk_1` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`) ON DELETE CASCADE;
...
--
ALTER TABLE `logs_sesiones`
  ADD CONSTRAINT `logs_sesiones_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`);
